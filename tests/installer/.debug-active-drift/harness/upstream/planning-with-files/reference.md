...
|------|---------|--------------|--------------|
| `planning/active/<task-id>/task_plan.md` | Phase tracking, progress | Task start | After completing phases |
| `planning/active/<task-id>/findings.md` | Discoveries, decisions | After ANY discovery | After viewing images/PDFs |
| `planning/active/<task-id>/progress.md` | Session log, what's done | At breakpoints | Throughout session |
