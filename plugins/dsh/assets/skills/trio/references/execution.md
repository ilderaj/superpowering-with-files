...
`visible_worker_required` is opt-in, not a default or release requirement for ordinary direct or native work. Do not select it merely to test Host capability, recover a default task, or gate an unrelated version.
