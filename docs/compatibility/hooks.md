...
Hooks only remind. They do not force a new thread, terminate a continuation, or turn this v1 guidance into runtime enforcement; the behavior stays soft guidance.
