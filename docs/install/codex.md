...
- Ownership contains the five existing primary Trio surfaces. Supporting reference files may be absent or already owned; all owned content must match its identity (`sha256:<hex>`).
