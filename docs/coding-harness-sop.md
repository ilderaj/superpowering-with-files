...
| The work produces or changes something a person looks at (a screen, page, dashboard, prototype, demo, mockup, wireframe, or slide/deck layout), or a visual design choice is disputed. | `ux-design` | State the reader and their task, the observable design decisions, and the named anti-patterns before building; inspect the rendered output at real size and record what was checked. | Publish, deploy, share, or claim acceptance; treat a generated file or design export as user-visible delivery; invent brand assets, copy, or metrics. |
