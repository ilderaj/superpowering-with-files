...
- Re-enter `Assess` on the next review result or gate change, or at the 15-minute cadence, whichever happens first.
...
- Record `next_reassess_due_at` whenever rereview waiting is handed off before a fresh observation arrives.
