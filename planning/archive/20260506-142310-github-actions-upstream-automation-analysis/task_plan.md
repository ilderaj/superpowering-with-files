...
- Companion plan: `planning/archive/20260506-142310-github-actions-upstream-automation-analysis/companion_plan.md`
- Companion summary: 保存详细实施清单、rollout gates、文件级任务拆分和启用顺序。
