...
Use this vocabulary to clarify design choices. Preserve the project's established domain language; distinguish meanings when a local term differs.
...
- **Justify indirection.** Variation between production and a realistic test adapter can justify a seam; do not invent adapters merely to meet a count. Preserve existing contracts when consolidating.
...
- **Ambiguous boundaries**: distinguish a test seam from a domain bounded context when the project uses both.
